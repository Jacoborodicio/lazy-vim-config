...
return {
  "hrsh7th/nvim-cmp",
  enabled = true, -- 🔥 Aseguramos que el plugin esté activo
  dependencies = {
    "L3MON4D3/LuaSnip",
  ...
  opts = function(_, opts)
    opts = opts or {} -- 🔥 Evita que opts sea nil

    local cmp = require("cmp")
    local luasnip = require("luasnip")

    -- Aseguramos que las fuentes de cmp existen antes de modificarlas
    opts.sources = cmp.config.sources(vim.tbl_deep_extend("force", opts.sources or {}, {
